...
- **Translation Workflows**: Ensuring content parity across language folders (root for `en/`, `es/`, `zh-cn/`)
...
- **Always** mirror content structure: if adding `guides/example.md` (English root), also add `es/guides/example.md` and `zh-cn/guides/example.md`
...
- **Root folder** (`src/content/docs/`) = English (en) content
- **Chinese**: `src/content/docs/zh-cn/guides/` and `src/content/docs/zh-cn/reference/`
