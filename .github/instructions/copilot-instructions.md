...
- **Content Structure**: All documentation lives in `src/content/docs/` with language-specific subfolders (`es/`, `zh-cn/`, root for en)
...
- **Adding New Guide**: Create `src/content/docs/guides/new-feature.md` (English) with frontmatter, then translate to `es/` and `zh-cn/`
